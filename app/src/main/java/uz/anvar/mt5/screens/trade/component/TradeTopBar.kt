package uz.anvar.mt5.screens.trade.component
...
internal fun TradeTopBar(
    ...
    TopAppBar(
        title = {
            Text("Trade", style = AppTheme.typography.secondary18Medium)
        },
        navigationIcon = {
...
@Composable
private fun PreviewTradeTopBar() {
    AppTheme {
        TradeTopBar(
            state = TradeState(),
            onAction = {},
